<template>
  <div class="main">
    <div style="width: 100%; height: 115px; background-color: #41d2a9; margin-top: -7px;">
      <div
        ...
        <!-- 第三行 -->
        <div style="margin-left: -540px; margin-top: -10px; font-size: 12px; color: #ffffff;">热门搜索</div>
      </div>


    </div>
    <div class="total"> 共<span class="total-number">{{ total }}</span>件相关需求</div>
    <!-- 品种导航 -->
    <el-breadcrumb class="navigation" separator=">">
      <el-breadcrumb-item><a @click="chooseVarietysBack(-1)">需求选择</a></el-breadcrumb-item>
