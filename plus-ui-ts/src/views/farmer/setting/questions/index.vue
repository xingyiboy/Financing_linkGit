  ...
  <div style="width: 1400px;" class="p-2">
    ...
    <el-card shadow="never">
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete()"
              v-hasPermi="['financinglink:questionsAnswers:remove']">删除</el-button>
          </el-col>
          <el-col :span="1.5">
      ...
      <el-table v-loading="loading" :data="questionsAnswersList" @selection-change="handleSelectionChange">
        ...
        <el-table-column style="color: red;" label="农作物名称" align="center" prop="flName" />
        <el-table-column style="color: red;" label="手机号" align="center" prop="phone" />
        <!-- <el-table-column label="回答" align="center" prop="answer" /> -->
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-button link type="primary" @click="handleDetail(scope.row)"
              v-hasPermi="['financinglink:questionsAnswers:edit']">详情</el-button>
            <el-button link type="primary" @click="handleUpdate(scope.row)"
              v-hasPermi="['financinglink:questionsAnswers:edit']">修改</el-button>
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="1000px" append-to-body>
      <el-form ref="questionsAnswersFormRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="标题" prop="title">
          <el-input :disabled="watchDetail" v-model="form.title" placeholder="请输入标题" />
        </el-form-item>
        <el-form-item label="内容">
          <el-input :disabled="watchDetail" v-model="form.content" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="作物名称" prop="flName">
          <el-input :disabled="watchDetail" v-model="form.flName" placeholder="请输入农作物名称" />
        </el-form-item>
        <el-form-item label="手机号" prop="flName">
          <el-input :disabled="watchDetail" v-model="form.phone" placeholder="请输入联系人手机号" />
        </el-form-item>
        <el-form-item v-if="watchDetail" label="回答">
          <el-input :disabled="watchDetail" v-model="form.answer" placeholder="无" />
        </el-form-item>
      </el-form>
      <template #footer>
...
import { listQuestionsAnswersMy as listQuestionsAnswers, getQuestionsAnswers, delQuestionsAnswers, addQuestionsAnswers, updateQuestionsAnswers } from '@/api/financinglink/questionsAnswers';
