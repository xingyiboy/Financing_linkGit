  ...
  <div class="p-2">
        ...
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            ...
            <el-form-item label="地址编号" prop="addressCode">
              <el-input v-model="queryParams.addressCode" placeholder="请输入地址编号" clearable @keyup.enter="handleQuery" />
            </el-form-item>
    ...
    <el-card shadow="never">
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="primary" plain icon="Plus" @click="handleAdd"
              v-hasPermi="['financinglink:goodsOrder:add']">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate()"
              v-hasPermi="['financinglink:goodsOrder:edit']">修改</el-button>
          </el-col>
          <el-col :span="1.5">
      ...
      <el-table v-loading="loading" :data="goodsOrderList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="商品首页图" align="center" prop="homePictureUrl" width="100">
          ...
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                v-hasPermi="['financinglink:goodsOrder:edit']"></el-button>
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                v-hasPermi="['financinglink:goodsOrder:remove']"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
...
/** 修改按钮操作 */
const handleUpdate = async (row?: GoodsOrderVO) => {
  reset();
