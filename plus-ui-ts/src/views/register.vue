  ...
  <div class="register">
    <el-form ref="registerRef" :model="registerForm" :rules="registerRules" class="register-form">
      ...
      <el-form-item prop="roleId">
        <el-select v-model="registerForm.roleId" placeholder="用户角色" clearable>
          <el-option v-for="dict in out_register_role" :key="dict.value" :label="dict.label" :value="dict.value" />
        </el-select>
      </el-form-item>
...
const { out_register_role } = toRefs<any>(proxy?.useDict('out_register_role'));
  ...
  registerRef.value?.validate(async (valid: boolean) => {
    if (valid) {
      ...
      if (!err) {
        ...
        localStorage.setItem('username', String(registerForm.value.username));
        localStorage.setItem('password', String(registerForm.value.password));
...
.register {
  ...
  align-items: center;
  height: 100%;
  background-image: url('../assets/avatar/rongxiaotong.gif');
